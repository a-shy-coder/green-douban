 ...
 * 提交图书评论的Servlet
 */
@WebServlet("/submitBookCommentServlet")
public class SubmitBookCommentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 提交评论
        int bookCommentId = bookCommentService.submitBookComment(new BookComment(bookId,commentContent,uid, date,0));

        // 将多项信息以JSON格式返回给前端
        Map<String,Object> map = new HashMap<String,Object>();

        // 评论编号
        map.put("bookCommentId",bookCommentId);

        // 评论时间
        map.put("bookCommentTime", DateFormatUtil.formatDateTime(date));
