...
@WebServlet("/modifyOneMovieServlet")
public class ModifyOneMovieServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Movie movie = new Movie(id,chineseName,originName,type,0,0,releaseDate,0,language,time,area,content,cover);
        int rows = movieService.modifyMovieById(movie);
    }
}