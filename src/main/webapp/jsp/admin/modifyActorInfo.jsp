...
<script>
    $(document).ready(function (){
        ...
        $("#addActorBtn").click(function () {
            $.ajax({
                url:"modifyOneActorServlet",
                type: "POST",
                data:{
                    "id":${requestScope.actor.actorId},
...
<div class="container ml-auto clearfix" style="margin-top: 70px">
    <div id="article" class="float-left mt-3" style="width: 770px;">
        <h1 class="title mb-4">修改演员</h1>
        <hr>
        <div style="width: 400px">
            <form>
                <h6>中文名</h6>
                <div class="md-form form-sm">
                    <input type="text" id="chineseName" class="form-control" value="${requestScope.actor.actorChineseName}">
                    <label for="chineseName" class="">演员中文名</label>
                </div>
                <h6>原名</h6>
                <div class="md-form form-sm">
                    <input type="text" id="originName" class="form-control" value="${requestScope.actor.actorOriginName}">
                    <label for="originName" class="">演员原名</label>
                </div>
                <h6>个人照</h6>
                <div class="md-form">
                    <div style="width: 160px;   display:inline-block">
                        <img class="cover" id="cover" src="${requestScope.actor.actorImg}">
                    </div>
                ...
                <h6>性别</h6>
                <div class="md-form form-sm">
                    <input type="text" id="gender" class="form-control" value="${requestScope.actor.actorGender}">
                    <label for="gender" class="">性别</label>
                </div>
                <h6>简介</h6>
                <div class="md-form md-outline">
                    <textarea id="content" class="md-textarea form-control" rows="3">${requestScope.actor.actorInfo}</textarea>
                    <label for="content">演员简介....</label>
                </div>
                <button class="btn btn-light-green btn-sm" id="addActorBtn" type="button">确认修改</button>
            </form>
        </div>
