...
<script>
    $(document).ready(function (){
        ...
        $("#addAuthorBtn").click(function () {
            $.ajax({
                url:"modifyOneAuthorServlet",
                type: "POST",
                data:{
                    "id":${requestScope.author.authorId},
        ...
        <div style="width: 400px">
            <form>
                ...
                <div class="md-form form-sm">
                    <input type="text" id="chineseName" class="form-control" value="${requestScope.author.authorChineseName}">
                    <label for="chineseName" class="">作者中文名</label>
                </div>
                <h6>原名</h6>
                <div class="md-form form-sm">
                    <input type="text" id="originName" class="form-control" value="${requestScope.author.authorOriginName}">
                    <label for="originName" class="">作者原名</label>
                </div>
                <h6>个人照</h6>
                <div class="md-form">
                    <div style="width: 160px;   display:inline-block">
                        <img class="cover" id="cover" src="${requestScope.author.authorImg}">
                    </div>
                ...
                <h6>性别</h6>
                <div class="md-form form-sm">
                    <input type="text" id="gender" class="form-control" value="${requestScope.author.authorGender}">
                    <label for="gender" class="">性别</label>
                </div>
                <h6>简介</h6>
                <div class="md-form md-outline">
                    <textarea id="content" class="md-textarea form-control" rows="3">${requestScope.author.authorInfo}</textarea>
                    <label for="content">作者简介....</label>
                </div>
                <button class="btn btn-light-green btn-sm" id="addAuthorBtn" type="button">确认修改</button>
            </form>
        </div>
    </div>
    <!-- 侧边栏 -->
